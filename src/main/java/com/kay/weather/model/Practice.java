...
public class Practice implements Serializable {
    ...
    public Practice(String base, String visibility, String id, JSONObject coord, JSONArray weather, JSONObject main, JSONObject wind, JSONObject clouds, JSONObject sys, String timezone, String name) {
        this.base = base;
